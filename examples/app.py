...
from examples.layouts import BlogDataClassFilter, BlogFilter, BlogIdPath, BlogPydanticFilter, PaginationParams
...
async def get_example3(
    filter_: BlogDataClassFilter = Depends(),
) -> dict[str, Any]:
